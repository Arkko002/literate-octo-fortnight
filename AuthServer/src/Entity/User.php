...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(targetEntity: UserConsent::class, mappedBy: 'consentingUser', orphanRemoval: true)]
    ...
    public function addUserConsent(UserConsent $userConsent): static
    {
        if (!$this->userConsents->contains($userConsent)) {
            ...
            $userConsent->setConsentingUser($this);
        }
    ...
    public function removeUserConsent(UserConsent $userConsent): static
    {
        if ($this->userConsents->removeElement($userConsent)) {
            ...
            if ($userConsent->getConsentingUser() === $this) {
                $userConsent->setConsentingUser(null);
            }
        }
